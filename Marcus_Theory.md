...
Using multicore and Numba to accerate the simulation
...
# ─────────────── user parameters ──────────────────────────────────────
FNAME             = Path("e-coupling_with_nn_distance-e-coupling-acceptor.txt")
...
if USE_GEOM_FILTER:
    ...
    expr = 89.4474*(x-0.667188)**2  -  2*0.22426*(x-0.667188)*(y-48.8267)+0.0022785*(y-48.8267)**2 
