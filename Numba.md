...
| Need to run on many nodes / HPC super-computer | **mpi4py** | Gives explicit MPI (MPICH/OpenMPI) in Python—Numba kernels run in each rank, while MPI handles domain decomposition or tree-exchange | $1000\times$ scale-outs in astrophysical N-body |
